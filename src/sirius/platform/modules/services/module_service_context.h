...
#ifndef SIRIUS_PLATFORM_MODULES_SERVICES_MODULE_SERVICE_CONTEXT_H
#define SIRIUS_PLATFORM_MODULES_SERVICES_MODULE_SERVICE_CONTEXT_H
...
namespace sirius::platform::modules::services
{
	...
	class CModuleServiceContext final
	{
	public:
		explicit CModuleServiceContext(CModuleContext &Context) noexcept;
		~CModuleServiceContext() noexcept;

		CModuleServiceContext(const CModuleServiceContext &Other) = delete;
		CModuleServiceContext &operator=(const CModuleServiceContext &Other) = delete;
		CModuleServiceContext(CModuleServiceContext &&Other) = delete;
		CModuleServiceContext &operator=(CModuleServiceContext &&Other) = delete;

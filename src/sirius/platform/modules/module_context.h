...
#ifndef SIRIUS_PLATFORM_MODULES_MODULE_CONTEXT_H
#define SIRIUS_PLATFORM_MODULES_MODULE_CONTEXT_H
...
namespace sirius::platform::modules
{
	...
	class CModuleContext final
	{
	public:
		CModuleContext(core::runtime::CCoreRuntime &Runtime, core::events::CEventDispatcher &Events, core::config::CConfigRegistry &Config, core::logging::CLogger &Logger, core::tasks::CTaskDispatcher &Tasks) noexcept;
		~CModuleContext() noexcept;

		CModuleContext(const CModuleContext &Other) = delete;
		CModuleContext &operator=(const CModuleContext &Other) = delete;
		CModuleContext(CModuleContext &&Other) = delete;
		CModuleContext &operator=(CModuleContext &&Other) = delete;

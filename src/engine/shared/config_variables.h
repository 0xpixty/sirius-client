...
MACRO_CONFIG_INT(ClMClientFrozenHud, cl_mclient_frozen_tees_hud, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: show frozen tees of your team on the HUD")
...
MACRO_CONFIG_INT(ClMClientInfoBarClock, cl_mclient_infobar_clock, 1, 0, 3, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: info bar clock widget (0 off, 1 left, 2 center, 3 right)")
MACRO_CONFIG_INT(ClMClientInfoBarFps, cl_mclient_infobar_fps, 1, 0, 3, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: info bar FPS widget (0 off, 1 left, 2 center, 3 right)")
MACRO_CONFIG_INT(ClMClientInfoBarPing, cl_mclient_infobar_ping, 1, 0, 3, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: info bar ping widget (0 off, 1 left, 2 center, 3 right)")
MACRO_CONFIG_INT(ClMClientInfoBarPred, cl_mclient_infobar_pred, 1, 0, 3, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: info bar prediction widget (0 off, 1 left, 2 center, 3 right)")
...
MACRO_CONFIG_COL(ClMessageTranslatedColor, cl_message_translated_color, 9895847, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: color of chat messages that were translated")
MACRO_CONFIG_INT(ClChatTranslate, cl_chat_translate, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: translate foreign chat messages")
MACRO_CONFIG_STR(ClChatTranslateInTarget, cl_chat_translate_in_target, 8, "en", CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: language incoming chat is translated to")
MACRO_CONFIG_STR(ClChatTranslateIgnore, cl_chat_translate_ignore, 64, "en", CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: comma-separated language codes that are kept untranslated in incoming chat")
...
MACRO_CONFIG_STR(ClChatTranslateOutSource, cl_chat_translate_out_source, 8, "de", CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: language you write in the translate chat")
MACRO_CONFIG_STR(ClChatTranslateOutTarget, cl_chat_translate_out_target, 8, "en", CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: language the translate chat sends your messages in")

...
MACRO_CONFIG_INT(ClFoeAnonymize, cl_foe_anonymize, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Fully anonymize tees on your foe list")
...
MACRO_CONFIG_INT(ClChatTranslate, cl_chat_translate, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: translate foreign chat messages")

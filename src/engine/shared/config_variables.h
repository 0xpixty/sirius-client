...
MACRO_CONFIG_INT(UiSettingsPage, ui_settings_page, 10, 0, 13, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Interface settings page")
...
MACRO_CONFIG_INT(UiCursorSize, ui_cursor_size, 99, 0, 99, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Cursor size in %")
